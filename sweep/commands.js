...
const commands = new CommandArgument(types.root, settings.prefix, null).setOptions([
	...
	new CommandArgument(types.command, "help minesweeper", "Lists available commands.", true)
